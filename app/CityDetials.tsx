...
// import StanderdPage from "./Components/StanderdPage";
import Link from "next/link";
import CityDetailsCard from "./cityDetials/Components/CityDetialCard";
    ...
    return (
        <div className="p-4">
            <div className="relative w-full max-w-2xl my-6 mx-auto">
                ...
                <Input type="text" placeholder="Search City" className="pl-12 pr-4" value={searchText} onChange={handleInputChange}  />
            </div>
              ...
              
            {
              filteredCities.length > 0 ? (
                  ...
                  filteredCities.map((city, index) => {
                      ...
                      return <div key={index} onClick={()=>router.push(`/${city.country}/${city.name}`)} >  <CityDetailsCard key={index} city={city} /> </div>
                  })
